...
## Main
- observed_main_before_this_edit: `37002e3f1071ff20a9180530c4788416c1308f31`
- last_verified: `2026-08-18T03:50:00Z`
- latest_publication: `37002e3f1071ff20a9180530c4788416c1308f31` — automatic Web publication created after #743 landed.
- latest_substantive_player_runtime_change: `cf2433da792d3bd4616f2a27e6924de412c474aa` — shared presentation-only OSM rail surface; #743 is QA-only and does not change gameplay geometry/materials.
- rule: re-read live `main`, open PRs and changed-file ownership before every branch, merge, rejection or production claim.

## Active ownership
- #742 — Midi official street-surface collision only. Owns `urbis_midi_builder.gd`, Midi collision tests/workflows and rendered-main baseline. Base is `b869552e...`, so it is stale after #743/publication; do not merge without rebuilding/revalidating from current main.
...
## NOW / NEXT / LATER
- NOW: production HEAD is `37002e3f...`; publication includes #743 QA. No Brasseurs runtime facade is shipped.
...
- Midi/Fonsny entrance remains generic; two source-backed micro-approaches prove additive detail and canopy-only correction are insufficient at normal player distance.
