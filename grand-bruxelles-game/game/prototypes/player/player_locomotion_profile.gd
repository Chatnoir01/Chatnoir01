extends RefCounted
class_name GrandBruxellesPlayerLocomotionProfile

## Clean-room locomotion layer designed to sit underneath the existing Player API.
## It intentionally does not own vehicle entry, direct Brussels spawns, mobile UI or missions.
