extends RefCounted
class_name GrandBruxellesVehicleDynamics60Hz

## Clean-room 60 Hz vehicle dynamics probe.
## Uses general spring-damper / tire-force principles; no third-party source copied.
...
func recommended_physics_hz() -> int:
    return 60
