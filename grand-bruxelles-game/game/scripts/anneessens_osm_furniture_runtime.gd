extends "res://game/scripts/anneessens_osm_furniture_strict_runtime.gd"

# Fail-closed provenance boundary for canonical OSM identities. The backing
# runtime preserves the previously qualified placement/geometry/lifecycle;
# this canonical production entrypoint narrows only OSM identity types.
