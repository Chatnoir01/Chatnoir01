...
func _apply_when_ready() -> void:
    ...
    print("GRAND_PLACE_OWNER_IDENTITY_PRESENTATION_READY owners=%d surfaces=%d geometry_changed=false collisions_changed=false focus_contrast_guarded=true focus_visibility_guarded=true" % [OWNER_PRESENTATION.size(), owner_surface_count])
