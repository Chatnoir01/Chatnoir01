...
const BACKGROUND_ENERGY := 0.92
const AMBIENT_COLOR := Color(0.76, 0.79, 0.82, 1.0)
const AMBIENT_ENERGY := 0.72
const TONEMAP_EXPOSURE := 1.07
const ADJUSTMENT_BRIGHTNESS := 1.015
const ADJUSTMENT_CONTRAST := 1.06
const ADJUSTMENT_SATURATION := 0.96
const FOG_COLOR := Color(0.74, 0.76, 0.77, 1.0)
const FOG_ENERGY := 0.58
const FOG_DENSITY := 0.0021
const FOG_SKY_AFFECT := 0.55
const SUN_ROTATION := Vector3(-44.0, -30.0, 0.0)
const SUN_COLOR := Color(1.0, 0.95, 0.86, 1.0)
const SUN_ENERGY := 1.10
