extends Node3D
class_name TrafficCrossingPedestrian
...
func configure(descriptor: Dictionary, crossing_system: RefCounted, new_pedestrian_id: int, reverse_direction: bool, wait_seconds: float) -> void:
