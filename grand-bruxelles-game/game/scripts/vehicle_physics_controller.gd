...
func _ready() -> void:
    ...
    # First production A/B pass locks roll/pitch so the comparison isolates the
    # drivetrain, tire grip and suspension stack. These axes can be unlocked
    # after tuning the actual center of mass and wheel geometry.
