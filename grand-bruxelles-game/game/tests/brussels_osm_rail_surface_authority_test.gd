...
func _run() -> void:
    ...
    # Familiar anchor names under an arbitrary wrapper are not production authority.
    ...
    # Preserve the established dormant/editor contract: root-level Viewport -> Main.
