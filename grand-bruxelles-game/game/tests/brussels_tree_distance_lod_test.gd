...
func _run() -> void:
    ...
    # Rebuild twice in the same frame. Batch names must remain stable rather
    # than acquiring Godot-generated suffixes from deferred deletion.
    runtime._points = {
        "tree": [
            {"osm_id": 101, "position": near_base},
            {"osm_id": 202, "position": far_base},
        ],
        "street_lamp": [],
        "bollard": [],
    }
