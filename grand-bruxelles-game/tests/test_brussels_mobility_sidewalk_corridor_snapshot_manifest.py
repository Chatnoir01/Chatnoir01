...
EXPECTED_BASE = "078befc176f26f0ece55cad3a2fdc3c79f1e700c"
...
def test_snapshot_manifest_matches_merged_source_lock() -> None:
    ...
    assert manifest["production_base_sha"] == EXPECTED_BASE
    assert manifest["source_lock_merge_pr"] == 1146
    assert manifest["source_lock_merge_sha"] == EXPECTED_BASE
