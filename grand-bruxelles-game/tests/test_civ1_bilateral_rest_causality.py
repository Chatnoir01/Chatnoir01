...
def main() -> int:
    ...
    complete = payload()
    complete["left_foot_reference_ab"] = left_control()
    ...
    assert blocked_cause["verdict"] == "BLOCK_UNSUPPORTED_BILATERAL_REST_ATTRIBUTION"
    assert blocked_cause["right_rest_direction_causality_supported"] is False
