...
def main() -> None:
    ...
    for token in (
        ...
        "counterfactual_source_parent_plus_target_relative",
        "baseline_right_final_phase_delta_samples",
        "counterfactual_right_final_phase_delta_samples",
        "counterfactual_improves_phase",
        "counterfactual_left_control_non_regression",
