...
def main()->int:
    # Exact rebuilt-shape regression from artifact 9989236424: minimum 119, both adjacent samples within 10 mm.
    ys=[0.25]*120
    ...
    # Positive control: the bracket becomes only a quantitative candidate when the dedicated seam frames are supplied.
