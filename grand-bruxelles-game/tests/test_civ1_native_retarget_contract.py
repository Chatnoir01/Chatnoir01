...
def main() -> None:
    ...
    for token in (
        ...
        '"grand-bruxelles-civ1-global-chain-diagnostic-v3"',
        '"model_space_samples"',
        ...
        '"baseline_target_vertical_min_sample_index"',
        '"normalized_target_vertical_min_sample_index"',
