...
def main() -> None:
    ...
    for token in (
        ...
        "reset_bone_pose(target_right_idx)",
        ...
        '"source_right_lower_leg_points"',
        '"target_right_lower_leg_points"',
        '"source_right_foot_points"',
        '"target_right_foot_points"',
    ...
    for token in (
        ...
        "baseline_right_source_overlap_samples",
        "normalized_right_source_overlap_samples",
        "baseline_right_primary_center_error_samples",
        ...
        "assert right_phase_center_improved is True",
