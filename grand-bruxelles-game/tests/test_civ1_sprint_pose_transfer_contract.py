...
def main() -> None:
    ...
    for token in (
        "grand-bruxelles-civ1-sprint-pose-transfer-v3",
        ...
        "source_left_upper_leg_m",
        "source_left_lower_leg_m",
        "source_right_upper_leg_m",
        "source_right_lower_leg_m",
        "target_left_upper_leg_m",
        "target_left_lower_leg_m",
        "target_right_upper_leg_m",
        "target_right_lower_leg_m",
