...
@pytest.mark.parametrize("field,value",[("artifact_kind","photo_match"),("base_sha","2222222222222222222222222222222222222222"),("head_sha",BASE_SHA),("resolution",[1280,960]),("camera_position",[320.0,1.72,-535.20]),("fov_deg",61.0),("human_review_required",False),("human_review_status","approved")])
