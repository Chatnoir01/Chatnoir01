...
from tools.qa.acquire_osm_road_extension_candidate import canonical_json, measurement_production_base_sha, sha256_bytes, segment_bbox_intersects
...
class OsmRoadExtensionAcquisitionTests(unittest.TestCase):
    ...
    def test_locked_phase_uses_immutable_acquisition_floor_not_mutable_live_sha(self):
        ...
        self.assertIn('c["production_base_sha"] == sys.argv[1]', workflow)
