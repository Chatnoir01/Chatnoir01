...
def main() -> None:
    ...
    require("grand-bruxelles-quaternius-ik-godot-characterization-v3" in probe, "probe format is not pinned to v3")
    ...
    require("kinematic_metrics" in workflow, "workflow does not preserve measured kinematic evidence")
    ...
    print("QUATERNIUS_IK_CHARACTERIZATION_CONTRACT_OK: v3_position_kinematics=locked")
