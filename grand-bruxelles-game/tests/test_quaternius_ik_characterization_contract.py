...
def main() -> None:
    ...
    require("player.seek" in probe and "get_bone_global_pose" in probe and "force_update_all_bone_transforms" in probe, "animated Skeleton3D pose sampling is missing")
