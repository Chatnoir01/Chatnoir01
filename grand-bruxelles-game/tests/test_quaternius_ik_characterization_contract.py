...
def main() -> None:
    ...
    require("grand-bruxelles-quaternius-ik-godot-characterization-v1" in probe, "probe format is not pinned")
    ...
    require("actions/upload-artifact@v4" in workflow, "evidence artifact is not published")
