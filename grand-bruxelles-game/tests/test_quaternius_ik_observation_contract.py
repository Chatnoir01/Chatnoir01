...
def main() -> None:
    ...
    require("grand-bruxelles-quaternius-ik-observation-context-v1" in probe, "probe format not pinned")
    ...
    require('"grounding_verified": false' in probe and '"foot_slide_verified": false' in probe, "source-track diagnostic must not claim target grounding")
    ...
    print("QUATERNIUS_IK_OBSERVATION_CONTRACT_OK: per_rig_track_motion=locked_fail_closed")
