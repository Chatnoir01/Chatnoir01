...
def main() -> None:
    ...
    require("grand-bruxelles-quaternius-ik-observation-context-v4" in probe, "direct skeleton evaluator probe format not pinned")
    ...
    require("track_get_path" in probe and "get_concatenated_subnames" in probe, "direct evaluator does not resolve imported bone track targets")
    require("direct_pose_state_restored_after_measurement" in probe, "direct evaluator restoration evidence missing")
    ...
    require("direct_track_pose_measurement" in workflow and "direct_pose_state_restored_after_measurement" in workflow, "workflow does not validate reversible direct evaluator")
    ...
    print("QUATERNIUS_IK_OBSERVATION_CONTRACT_OK: reversible_direct_track_pose=locked_fail_closed")
