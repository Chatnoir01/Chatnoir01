...
@pytest.mark.parametrize(
    ...
    [
        ("id", "duplicate locked artifact identity"),
        ("name", "artifact name identity drift"),
        ("archive_sha256", "duplicate locked artifact identity"),
    ],
)
def test_derivation_rejects_duplicate_locked_artifact_identity(field: str, expected_error: str):
