...
def analyze(receipt: dict) -> dict:
    ...
    raw_within_rail = receipt.get("max_within_distance_relative_deviation")
    # The v1 receipt stores observed deviations under this key, so freeze the rail
    # independently here instead of trusting a self-declared threshold.
