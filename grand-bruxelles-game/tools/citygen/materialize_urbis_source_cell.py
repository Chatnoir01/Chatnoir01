...
LAYER = "urbisvector:Buildings"  # backwards-compatible public constant
...
def _materialize_intersection_layer(
    *,
    logical_name: str,
    wfs_name: str,
    relative_file: str,
...
def materialize_base_city(
    cell_id: str,
    bbox: tuple[float, float, float, float],
    output_dir: Path,
    layer_fetcher: Callable[[str, tuple[float, float, float, float]], dict[str, Any]],
) -> dict[str, Any]:
