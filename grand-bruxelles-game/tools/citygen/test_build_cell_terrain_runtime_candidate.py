...
lod = {
    ...
    "crs": mod.CRS,
    "bbox": list(BBOX),
    "levels": [{"resolution_m": 2.0, "p95_abs_error_m": 0.08, "canonical_edge_compatible": True}],
    "selection": {"p95_threshold_m": 0.15, "canonical_edge_alignment_required": True, "selected_resolution_m": 2.0},
...
print("TERRAIN_RUNTIME_CANDIDATE_OK deterministic=true compact_uint16=true canonical_edges=true payload_integrity=true runtime_authorized=false")
