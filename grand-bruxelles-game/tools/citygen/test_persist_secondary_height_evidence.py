    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        write_json(
            secondary,
            {
                ...
                "counts": {
                    "manual_frontier_candidates": 7,
                    "semantic_joined_records": 5,
                    "strong_validation_candidates": 4,
                    "missing_secondary_records": 2,
                    "conflicts": 0,
                },
        ...
        write_json(
            validation,
            {
                ...
                "next_action": "resolve_blocked_secondary_height_candidates_without_guessing",
                "candidates": [],
            },
        )
        ...
        bad = json.loads(validation.read_text(encoding="utf-8"))
        bad["runtime_promotion_allowed"] = True
        write_json(validation, bad)
        try:
