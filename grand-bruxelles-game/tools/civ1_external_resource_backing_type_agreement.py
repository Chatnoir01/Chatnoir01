...
SCHEMA = "grand-bruxelles-civ1-external-resource-backing-type-agreement-v2"
...
def self_test() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        rows = [
            ...
            {"scene": "game/civ1.tscn", "line": 3, "path": "res://assets/npc.tscn", "type": "PackedScene"},
            {"scene": "game/civ1.tscn", "line": 4, "path": "res://assets/npc_skin.tres", "type": "Skin"},
        ]
        conflicts, determined = backing_type_conflicts(rows, root)
        assert determined == 3
        assert len(conflicts) == 1
        assert conflicts[0]["path"] == "res://assets/npc.gd"
        assert conflicts[0]["declared_type"] == "Texture2D"
...
def main() -> int:
    ...
    result = {
        "schema": SCHEMA,
        "evidence_mode": "reachable_tscn_external_resource_declared_type_vs_deterministic_backing_type_for_gd_tscn_and_header_position_validated_tres",
