...
SCHEMA = "grand-bruxelles-civ1-roster-registration-truth-v20"
...
def _source_url_reasons(value):
    ...
    if not _path_percent_encoding_is_canonical(parsed.path): reasons.append('source_url_not_canonical')
