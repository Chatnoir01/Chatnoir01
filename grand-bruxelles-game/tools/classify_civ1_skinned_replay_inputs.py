...
def main() -> int:
    ...
    for v in vertices:
        ...
        for inf in v['influences']:
            ...
            required.add(short_bone(str(inf['bone_name'])))
    ...
    print('CIV1_SKINNED_REPLAY_INPUT_COVERAGE_OK', 'required=', len(required), 'missing=', sorted(missing_union), 'authorized=', not missing_union)
    return 0
