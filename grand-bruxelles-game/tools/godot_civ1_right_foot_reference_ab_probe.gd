...
func _points_payload(points: Array[Vector3]) -> Array:
    var result: Array = []
    for point in points:
        result.append(_v3(point))
    return result
...
func _run() -> void:
    ...
    var source_right_lower_points: Array[Vector3] = []
    var target_right_lower_points: Array[Vector3] = []
    ...
    for sample_idx in range(SAMPLE_COUNT):
        ...
        source_right_lower_points.append(source_skeleton.get_bone_global_pose(source_right_lower_idx).origin)
        target_right_lower_points.append(target_skeleton.get_bone_global_pose(target_right_lower_idx).origin)
    ...
    var payload := {
        "format": "grand-bruxelles-civ1-right-foot-reference-ab-v2",
        ...
        "source_right_lower_leg_points": _points_payload(source_right_lower_points),
        "target_right_lower_leg_points": _points_payload(target_right_lower_points),
        "source_right_foot_points": _points_payload(source_right_points),
        "target_right_foot_points": _points_payload(target_right_points),
