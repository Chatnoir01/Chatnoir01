    ...
    *,
    ...
    for solid_id in sorted(solids):
        ...
        matches.append({
            ...
            "best_ground_coverage": None if best is None else best["ground_coverage"],
            "best_building_coverage": None if best is None else best["building_coverage"],
