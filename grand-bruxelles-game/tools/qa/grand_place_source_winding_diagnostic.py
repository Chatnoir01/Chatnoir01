...
def facing_stats(
    ...
    return {
        ...
        "raw_front_triangles": raw_front_count,
        "runtime_oriented_front_triangles": runtime_front_count,
        "triangles_flipped": flipped_count,
        "total_area_m2": total_area,
        "raw_front_area_ratio": raw_front_area / total_area,
        "runtime_oriented_front_area_ratio": runtime_front_area / total_area,
    }
...
def main() -> int:
    ...
    report = {
        ...
        "building_center": list(center),
        "wall_triangles": wall["triangles"],
        "roof_triangles": roof["triangles"],
        "raw_front_wall_triangles": wall["raw_front_triangles"],
        "raw_front_roof_triangles": roof["raw_front_triangles"],
        "runtime_oriented_front_wall_triangles": wall["runtime_oriented_front_triangles"],
        "runtime_oriented_front_roof_triangles": roof["runtime_oriented_front_triangles"],
        "wall_triangles_flipped_by_center_heuristic": wall["triangles_flipped"],
        "roof_triangles_flipped_upward": roof["triangles_flipped"],
        "raw_front_wall_area_ratio": wall["raw_front_area_ratio"],
        "raw_front_roof_area_ratio": roof["raw_front_area_ratio"],
        "runtime_oriented_front_wall_area_ratio": wall["runtime_oriented_front_area_ratio"],
        "runtime_oriented_front_roof_area_ratio": roof["runtime_oriented_front_area_ratio"],
