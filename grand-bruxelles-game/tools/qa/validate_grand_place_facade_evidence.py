...
def validate_evidence(gate_path: Path | str, manifest_path: Path | str, artifact_root: Path | str | None = None) -> dict[str, Any]:
    ...
    return {"artifact_kind":manifest["artifact_kind"],"base_sha":base_sha,"head_sha":head_sha,"resolution":list(expected_dims),"view_count":len(validated_files),"view_ids":view_ids,"files":validated_files,"png_sha256":validated_hashes,"source_surface_facing":source_surface_facing,"human_review_status":"pending","visual_approval_claimed":False}
