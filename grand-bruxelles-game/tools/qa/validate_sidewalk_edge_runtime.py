...
def main() -> None:
    ...
    for token in ['MATERIAL_FAMILY := "brussels_sidewalk_edge_v1"','placement_provenance','authored_presentation_from_existing_sidewalk_geometry','source_height_claimed','false','geometry_unchanged()','edge_count()','set_enhanced_enabled']:
