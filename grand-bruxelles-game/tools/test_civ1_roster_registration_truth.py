...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        for source in ("https://assets.character-fixtures.com/source/civilian%C2%A0alias.glb","https://assets.character-fixtures.com/source/civilian%E2%80%A8alias.glb","https://assets.character-fixtures.com/source/civilian%E2%80%A9alias.glb"):
            bad=validate_entry(candidate(rel,sha,source),root); assert "source_url_not_canonical" in bad["blocking_reasons"], (source,bad); assert bad["roster_eligible"] is False
        ...
        for source in ("https://[64:ff9b::808:808]/source/civilian.glb","https://[64:ff9b::7f00:1]/source/civilian.glb","https://[64:ff9b:1::808:808]/source/civilian.glb"):
            bad=validate_entry(candidate(rel,sha,source),root); assert "source_url_ipv6_nat64_forbidden" in bad["blocking_reasons"], (source,bad); assert bad["roster_eligible"] is False, (source,bad)
        ...
        assert "source_url_ipv6_nat64_forbidden" not in canonical_ipv6["blocking_reasons"], canonical_ipv6
    ...
    print("CIV1_ROSTER_REGISTRATION_TRUTH_V48_MALFORMED_UTF8_GREEN")
