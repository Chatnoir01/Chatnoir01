...
def main():
    with tempfile.TemporaryDirectory() as td:
        ...
        public_source="https://assets.character-fixtures.com/source/civilian.glb"
        assert is_local_network_source(public_source) is False
        public=validate_entry(candidate(rel,sha,public_source),root)
        assert "source_url_local_network_forbidden" not in public["blocking_reasons"], public
    ...
    print("CIV1_ROSTER_REGISTRATION_TRUTH_V38_LOCAL_NETWORK_INTEGRATION_GREEN")
