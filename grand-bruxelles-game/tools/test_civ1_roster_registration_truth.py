...
def main() -> None:
    with tempfile.TemporaryDirectory() as td:
        ...
        dup=build_payload({"schema":"grand-bruxelles-civ1-roster-registry-v1", "entries":[entry(rel, sha), entry(rel, sha, "police")]}, root)
        ...
        assert payload["registry_schema_contract_required"] is True
