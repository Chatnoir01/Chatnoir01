...
def main() -> None:
    with tempfile.TemporaryDirectory() as td:
        ...
        ambiguous = (
            ...
            "assets/characters/civilians/civ1/source/body\u2028variant.glb",
            "assets/characters/civilians/civ1/source/body\u2029variant.glb",
            # Lone UTF-16 surrogates can enter through JSON escapes but are not
            # valid portable filesystem text and must fail closed, not crash.
            "assets/characters/civilians/civ1/source/body\ud800.glb",
            "assets/characters/civilians/civ1/source/body\udfff.glb",
            "assets/characters/civilians/civ1/source/body./variant.glb",
            "assets/characters/civilians/civ1/source/CON.glb",
            "assets/characters/civilians/civ1/source/COM¹.glb",
            "assets/characters/civilians/civ1/source/COM².glb",
            "assets/characters/civilians/civ1/source/LPT³.glb",
            "assets/characters/civilians/civ1/source/body?.glb",
            "assets/characters/civilians/civ1/source/body*.glb",
            "assets/characters/civilians/civ1/source/body|variant.glb",
            "assets/characters/civilians/civ1/source/body<variant>.glb",
            'assets/characters/civilians/civ1/source/body"variant.glb',
            # NTFS file-name components are limited to 255 UTF-16 code units.
            "assets/characters/civilians/civ1/source/" + ("a" * 252) + ".glb",
            # Astral characters consume two UTF-16 code units each on Windows.
            "assets/characters/civilians/civ1/source/" + ("😀" * 127) + ".glb",
        )
