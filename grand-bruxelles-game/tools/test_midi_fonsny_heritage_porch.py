...
def main() -> None:
    ...
    for marker in ['"FonsnyHeritagePorch"','"PorchBlindUpperRegister"','"PorchGlassBlockBay_%02d"','"PorchBayVerticalCross_%02d"','"PorchBayHorizontalCross_%02d"','"PorchPerforatedCanopy"','"PorchPolygonalColumn_%02d"']:
