...
This validator is intentionally process-independent: it compares the PR base
catalog with the proposed catalog and refuses any new JOUABLE state. CI is not
allowed to turn that refusal into a pass. A human promotion therefore requires
an explicit repository-admin decision outside the automated green path.
"""
